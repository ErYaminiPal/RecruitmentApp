...
/**
 * REST controller for managing {@link net.marsbytes.app.recruitment.domain.Applicant}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Applicant> result = applicantRepository
            ...
            .map(
                existingApplicant -> {
                    ...
                    if (applicant.getSummary() != null) {
                        existingApplicant.setSummary(applicant.getSummary());
                    }
                    if (applicant.getcTC() != null) {
                        existingApplicant.setcTC(applicant.getcTC());
                    }
                    if (applicant.geteCTC() != null) {
                        existingApplicant.seteCTC(applicant.geteCTC());
                    }
                    if (applicant.getHighestEducation() != null) {
