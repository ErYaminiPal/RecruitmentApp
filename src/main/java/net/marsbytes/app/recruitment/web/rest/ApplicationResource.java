...
/**
 * REST controller for managing {@link net.marsbytes.app.recruitment.domain.Application}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingApplication -> {
                    if (application.getDateOfApplication() != null) {
                        existingApplication.setDateOfApplication(application.getDateOfApplication());
                    }
                    ...
                    if (application.getExperience() != null) {
                        existingApplication.setExperience(application.getExperience());
                    }
                    if (application.getOtherInfo() != null) {
                        existingApplication.setOtherInfo(application.getOtherInfo());
                    }
