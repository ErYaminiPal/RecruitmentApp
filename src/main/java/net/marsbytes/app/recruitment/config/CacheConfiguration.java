...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, net.marsbytes.app.recruitment.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, net.marsbytes.app.recruitment.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, net.marsbytes.app.recruitment.domain.User.class.getName());
            createCache(cm, net.marsbytes.app.recruitment.domain.Authority.class.getName());
