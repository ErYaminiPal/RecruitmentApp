...
import net.marsbytes.app.recruitment.domain.Application;
import net.marsbytes.app.recruitment.repository.ApplicationRepository;
...
class ApplicationResourceIT {
    ...
    private static final LocalDate DEFAULT_DATE_OF_APPLICATION = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_OF_APPLICATION = LocalDate.now(ZoneId.systemDefault());
    ...
    void createApplication() throws Exception {
        ...
        assertThat(testApplication.getDateOfApplication()).isEqualTo(DEFAULT_DATE_OF_APPLICATION);
        assertThat(testApplication.getEducation()).isEqualTo(DEFAULT_EDUCATION);
        assertThat(testApplication.getExperience()).isEqualTo(DEFAULT_EXPERIENCE);
        assertThat(testApplication.getOtherInfo()).isEqualTo(DEFAULT_OTHER_INFO);
    ...
    void getAllApplications() throws Exception {
        ...
        restApplicationMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateOfApplication").value(hasItem(DEFAULT_DATE_OF_APPLICATION.toString())))
    ...
    void getApplication() throws Exception {
        ...
        restApplicationMockMvc
            ...
            .andExpect(jsonPath("$.dateOfApplication").value(DEFAULT_DATE_OF_APPLICATION.toString()))
    ...
    void putNewApplication() throws Exception {
        ...
        Application testApplication = applicationList.get(applicationList.size() - 1);
        assertThat(testApplication.getDateOfApplication()).isEqualTo(UPDATED_DATE_OF_APPLICATION);
        assertThat(testApplication.getEducation()).isEqualTo(UPDATED_EDUCATION);
        assertThat(testApplication.getExperience()).isEqualTo(UPDATED_EXPERIENCE);
        assertThat(testApplication.getOtherInfo()).isEqualTo(UPDATED_OTHER_INFO);
    ...
    void partialUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.dateOfApplication(UPDATED_DATE_OF_APPLICATION).otherInfo(UPDATED_OTHER_INFO).name(UPDATED_NAME);
