...
import static net.marsbytes.app.recruitment.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import net.marsbytes.app.recruitment.config.Constants;
import net.marsbytes.app.recruitment.domain.PersistentToken;
import net.marsbytes.app.recruitment.domain.User;
import net.marsbytes.app.recruitment.repository.AuthorityRepository;
import net.marsbytes.app.recruitment.repository.PersistentTokenRepository;
import net.marsbytes.app.recruitment.repository.UserRepository;
import net.marsbytes.app.recruitment.security.AuthoritiesConstants;
import net.marsbytes.app.recruitment.service.UserService;
import net.marsbytes.app.recruitment.service.dto.AdminUserDTO;
import net.marsbytes.app.recruitment.service.dto.PasswordChangeDTO;
import net.marsbytes.app.recruitment.service.dto.UserDTO;
import net.marsbytes.app.recruitment.web.rest.vm.KeyAndPasswordVM;
import net.marsbytes.app.recruitment.web.rest.vm.ManagedUserVM;
